    ...
    <div class="menu">
      <div class="menu-logo-box">
        <svg overflow="visible" width="40px" height="40px" version="1.1" viewBox="0 0 40 40" x="0px" y="0px" class="ScSvg-cdc1ai-2 fMOUeO">
          <g>
            <polygon points="13 8 8 13 8 31 14 31 14 36 19 31 23 31 32 22 32 8" class="tw-body">
            ...
            <polygon points="26 25 30 21 30 10 14 10 14 25 18 25 18 29 22 25" class="tw-face">
